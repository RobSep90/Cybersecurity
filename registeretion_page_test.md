...
<link
	href="registeretion_page_test/normalize/normalize.css" rel="stylesheet">
<link
	href="registeretion_page_test/themes/original/main.css" rel="stylesheet">
<link
	href="registeretion_page_test/themes/original/colors.css" rel="stylesheet">
</head>
<body>
	<header>
		...
		<p>
			<span>Generated with</span> <a href="https://zaproxy.org"><img
				src="registeretion_page_test/zap32x32.png" alt="The ZAP logo" class="zap-logo">ZAP</a>
			<span>on Sat 23 Nov 2024, at 15:23:58</span>
		</p>
	...
	<main>
		...
		<section>
			<p>
				<strong>No alerts were found within the report parameters.</strong>
			</p>
		</section>
